...
public class DanmakuView extends View {
    ...
    private int mPickItemInterval = 100;//每隔多长时间取出一条弹幕来播放.
    ...
    private DamMuFinshListener listener;
    ...
    public DanmakuView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPickItemInterval = a.getInteger(R.styleable.DanmakuView_pick_interval, 100);
...
//                                Log.d(TAG, "Not find vacant channel, add it back");
    ...
    public interface DamMuFinshListener{
        public void Finish();
    }

    public void setDanMuFinishListener(DamMuFinshListener listener){
