...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	/** 表情页的监听事件 */
	private BiaoQingClickListener mListener;
	...
	public void setOnCorpusSelectedListener(BiaoQingClickListener listener) {
		mListener = listener;
	}

	public interface BiaoQingClickListener{
